import { solveDayPart1, solveDayPart2 } from './Day24';

const realText = `nenwnwnwnwnewnwsenwnwnwsenwnwsenwnenww
...
const part1Text = `sesenwnenenewseeswwswswwnenewsewsw
...
describe("Day24 tests", () => {
    it('solveDayPart1 solution with the 1st fake data is correct', () => {
        expect(solveDayPart1(part1Text)).toBe(10);
    });

    it('solveDayPart1 solution with real data is correct', () => {
        expect(solveDayPart1(realText)).toBe(523);
    });

    it('solveDayPart2 solution with the 1st fake data after 100 days is correct', () => {
        expect(solveDayPart2(part1Text)).toBe(2208);
    });

    it('solveDayPart2 solution with real data is correct', () => {
        expect(solveDayPart2(realText)).toBe(4225);
    });
});
