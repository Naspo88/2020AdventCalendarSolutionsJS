...
const realText = `light green bags contain 2 pale cyan bags.
...
const part1Text = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
const part2Text = `shiny gold bags contain 2 dark red bags.
...
describe("Day7 tests", () => {
    it('solvePart1 solution with fake data is correct', () => {
        expect(solvePart1(part1Text, 'shiny gold')).toBe(4);
    });

    it('solvePart1 solution with real data is correct', () => {
        expect(solvePart1(realText, 'shiny gold')).toBe(226);
    });

    it('solvePart2 solution with fake data is correct', () => {
        expect(solvePart2(part1Text, 'shiny gold')).toBe(32);
    });

    it('solvePart2 solution with fake data is correct', () => {
        expect(solvePart2(part2Text, 'shiny gold')).toBe(126);
    });
    
    it('solvePart2 solution with real data is correct', () => {
        expect(solvePart2(realText, 'shiny gold')).toBe(9569);
    });
});
