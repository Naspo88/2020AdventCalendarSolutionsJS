...
const realText = `eyr:2029 iyr:2013
...
const part1Text = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
const part2Text = `eyr:1972 cid:100
...
describe("Day4 tests", () => {
    it('solvePart1 solution with test data is correct', () => {
        expect(solvePart1(part1Text)).toBe(2);
    });

    it('solvePart1 solution with real data is correct', () => {
        expect(solvePart1(realText)).toBe(204);
    });

    it('solvePart2 solution with test data is correct', () => {
        expect(solvePart2(part2Text)).toBe(4);
    });

    it('solvePart2 solution with real data is correct', () => {
        expect(solvePart2(realText)).toBe(179);
    });
});
