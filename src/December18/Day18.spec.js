import { solveDay } from './Day18';

const realText = `5 + 8 * ((6 * 5 * 8 + 5 + 8) * 7 + 3)
6 * 7 + 7 * (9 * 6 + 6 + 4 * 6) * 5 * 4
((3 * 8 + 7) * 3 * 8 * 8 * 4 * 2) * 8
...
describe("Day18 tests", () => {
    it('solvePart1 solution with the 1st fake data is correct', () => {
        expect(solveDay(part1Text, false)).toBe(71 + 51 + 26 + 437 + 12240 + 13632);
    });

    it('solvePart1 solution with real data is correct', () => {
        expect(solveDay(realText, false)).toBe(701339185745);
    });

    it('solvePart2 solution with the 1st fake data is correct', () => {
        expect(solveDay(part1Text, true)).toBe(231 + 51 + 46 + 1445 + 669060 + 23340);
    });

    it('solvePart2 solution with real data is correct', () => {
        expect(solveDay(realText, true)).toBe(4208490449905);
    });
});
